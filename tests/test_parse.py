...
class ParseTest(unittest.TestCase):
    ...
    def testParseGLL(self):  # standard message
        res = NMEAReader.parse(self.messageGLL, 1)
    ...
    def testParsePUBX(self):  # proprietary UBX message
        res = NMEAReader.parse(self.messagePUBX, 1)
