...
NMEA_PAYLOADS_SET_PROP = {
    ...
    "QTMCFGANTENNA": NMEA_PAYLOADS_GET_PROP["QTMCFGANTENNA"],
    "QTMCFGANTINF": NMEA_PAYLOADS_GET_PROP["QTMCFGANTINF"],
    "QTMCFGBLD": NMEA_PAYLOADS_GET_PROP["QTMCFGBLD"],
    "QTMCFGCNRTHD": NMEA_PAYLOADS_GET_PROP["QTMCFGCNRTHD"],
    ...
    "QTMCFGEVENT": NMEA_PAYLOADS_GET_PROP["QTMCFGEVENT"],
    ...
    "QTMCFGPINALT": NMEA_PAYLOADS_GET_PROP["QTMCFGPINALT"],
    "QTMCFGPPS": NMEA_PAYLOADS_GET_PROP["QTMCFGPPS"],
    "QTMCFGRTKRL": NMEA_PAYLOADS_GET_PROP["QTMCFGRTKRL"],
    "QTMCFGSBAS": NMEA_PAYLOADS_GET_PROP["QTMCFGSBAS"],
    "QTMCFGSIGGRP": NMEA_PAYLOADS_GET_PROP["QTMCFGSIGGRP"],
    "QTMCFGSTANDALONE": NMEA_PAYLOADS_GET_PROP["QTMCFGSTANDALONE"],
    "QTMCFGPPS_DIS": {
        "status": QS,
        "ppsindex": IN,
        "enable": IN,  # should be 0
    },
    "QTMCFGPPP": NMEA_PAYLOADS_GET_PROP["QTMCFGPPP"],
    "QTMCFGPPS2": NMEA_PAYLOADS_GET_PROP["QTMCFGPPS2"],
